  ...
  return (
    ...
    >
      {stakingLimit.gt(0) && !isRemovingStake && (
        <Text color="#fff" bold mb="24px" style={{ textAlign: 'center' }} fontSize="16px">
      ...
      <Text ml="auto" color="#fff" fontSize="12px" mb="8px">
        {t('Balance: %balance%', {
      ...
      {!isRemovingStake && (
        <StyledLink external href={getTokenLink}>
          <Button width="100%" mt="8px" className='model-borderbtn'>
