...
const AprRow: React.FC<AprRowProps> = ({ pool, stakedBalance, performanceFee = 0 }) => {
  ...
  const tooltipContent = isAutoVault
    ? t('APY includes compounding, APR doesn’t. This pool’s Ritz is compounded automatically, so we show APY.')
  ...
  console.log('earningsPercentageToDisplay', earningsPercentageToDisplay)
