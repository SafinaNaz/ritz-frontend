  ...
  return (
    ...
    >
      ...
      <Flex alignItems="center" justifyContent="space-between" mt="8px">
        <StyledButton scale="xs" mx="2px" p="4px 16px" className="farms-btn" onClick={() => handleChangePercent(25)}>
          25%
        </StyledButton>
        <StyledButton scale="xs" mx="2px" p="4px 16px"className="farms-btn" onClick={() => handleChangePercent(50)}>
          50%
        </StyledButton>
        <StyledButton scale="xs" mx="2px" p="4px 16px" className="farms-btn" onClick={() => handleChangePercent(75)}>
          75%
        </StyledButton>
        <StyledButton scale="xs" mx="2px" p="4px 16px" className="farms-btn" onClick={() => handleChangePercent(100)}>
          {t('Max')}
        </StyledButton>
      </Flex>
        ...
        <Flex mt="24px" alignItems="center" justifyContent="space-between">
          ...
          <AnnualRoiContainer alignItems="center" onClick={() => setShowRoiCalculator(true)}>
            ...
            <IconButton variant="text" scale="sm">
              <CalculateIcon color="#fff" width="18px" />
            </IconButton>
          </AnnualRoiContainer>
        </Flex>
      )}
      <Button className="farms-btn"
        isLoading={pendingTx}
      ...
      {!isRemovingStake && (
        <Button mt="8px" as="a" external href={getTokenLink} className="farms-btn">
