      ...
      <ActionContent>
        <Flex flex="1" pt="16px" flexDirection="column" alignSelf="flex-start">
          <>
            {hasEarnings ? (
              <>
                <Balance lineHeight="1" bold color="#fff" fontSize="20px" decimals={5} value={earningTokenBalance} />
                {earningTokenPrice > 0 && (
                  <Balance
                    display="inline"
                    fontSize="12px"
        ...
        <Flex flex="1.3" flexDirection="column" alignSelf="flex-start" alignItems="flex-start">
          ...
          <Flex mb="2px" justifyContent="space-between" alignItems="center">
            ...
            <TooltipText color="#fff" ref={targetRef} small>
              {t('Performance Fee')}
            </TooltipText>
            <Flex alignItems="center">
              <Text color="#fff" ml="4px" small>
                {performanceFee / 100}%
              </Text>
            </Flex>
          </Flex>
