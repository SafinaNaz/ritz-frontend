...
const Farms: React.FC = () => {
  ...
  // console.log('farms data', farmsLP)
  ...
  const renderContent = (): JSX.Element => {
    ...
    // console.log('farmsssssss', cakePrice)
    const columnSchema = DesktopColumnSchema
  ...
  return (
    <>
             ...
             <ButtonToggle className="top-button-toggle">
              <Flex flexDirection='row' alignItems="center">
                <Flex className="button-toggle" >
                  <button className={`${Limit ? '' : 'active'}`} type="button" onClick={() => setLimit(s => !s)}>Active</button>
      ...
      backgroundSize: '200px'
        ...
        <div ref={observerRef} />
        {/* <StyledImage src="/images/decorations/3dpan.png" alt="RitzCoin illustration" width={120} height={103} /> */}
      </Page>
    </>
  )
}
