      ...
      <ButtonToggle className="top-button-toggle">
        <Flex flexDirection='row' alignItems="center">
          <Flex className="button-toggle" >
            <button className={`${Limit ? '' : 'active'}`} type="button" onClick={() => setLimit(s => !s)}>Swap</button>
      ...
      <AppBody>
        ...
        <Wrapper id="swap-page">
          <AutoColumn gap="md">
            ...
            {/* {Limit ? (
              <div className="">
              <Customdetail  value={formattedAmounts[Field.OUTPUT]}
              onUserInput={handleTypeOutput}
              label={independentField === Field.INPUT && !showWrap && trade ? t('To (estimated)') : t('Limit price')}
              showMaxButton={false}
              currency={currencies[Field.OUTPUT]}
              onCurrencySelect={handleOutputSelect}
              otherCurrency={currencies[Field.INPUT]}
              id="swap-currency-output" /></div>
            ) : null} */}
