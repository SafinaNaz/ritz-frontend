...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and Ritz pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and Ritz pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from Ritz pool', data)
  }
