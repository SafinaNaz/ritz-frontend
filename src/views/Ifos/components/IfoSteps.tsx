        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active Ritz Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('You’ll spend Ritz to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
      ...
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('When the IFO sales are live, you can “commit” your Ritz to buy the tokens being sold.')} <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent gRitz tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
