  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active Ritz Profile to buy Minting Tickets and mint a RitzCoin Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold RITZ'),
      bodyText: [t('Each NFT costs RITZ to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="swap?outputCurrency=0xa54BA6ecA24f31dE34BCBEe0077F7Da8765d933F"
            target="_blank"
            width="100%"
          >
            {t('Buy RITZ')}
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” RitzCoin Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active RitzCoin Profile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Claim Phase'),
      bodyText: [
        t('During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a RitzCoin Squad NFT.'),
      ],
      buttons: (
        <>
          {hasData && (
