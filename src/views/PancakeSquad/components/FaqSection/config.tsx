...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the RitzCoin Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 RitzCoin Bunny NFTs at the snapshot may also purchase one additional RitzCoin Squad NFT in the presale for each RitzCoin Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of Ritz spent on RitzCoin Squad NFTs will be burned as part of our weekly Ritz burn.')],
  },
  {
