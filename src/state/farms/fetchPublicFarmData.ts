...
const fetchFarm = async (farm: SerializedFarm): Promise<PublicFarmData> => {
  ...
  // console.log('tokennnnn', token, quoteToken)
  ...
  // console.log('quoteTokenBalanceLP', new BigNumber(quoteTokenBalanceLP).toString())
  // console.log('lpTokenBalanceMC', new BigNumber(lpTokenBalanceMC).toString())
  ...
  // for 0 value we using 0.000000000000000001 value but for testnet
