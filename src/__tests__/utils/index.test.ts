...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x8C8f93ab12384d201a24bd3f0C0B64d1B45c65Ea')).toBe('0x8C8f93ab12384d201a24bd3f0C0B64d1B45c65Ea')
      expect(isAddress('0x8C8f93ab12384d201a24bd3f0C0B64d1B45c65Ea')).toBe('0x8C8f93ab12384d201a24bd3f0C0B64d1B45c65Ea')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0x8C8f93ab12384d201a24bd3f0C0B64d1B45c65Ea')
    })
