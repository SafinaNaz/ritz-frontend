...
const RoiCardWrapper = styled(Box)`
  background: transparent linear-gradient(11deg,#FF416C 0%,#FF4B2B 100%) 0% 0% no-repeat padding-box;
  padding: 1px;
  width: 100%;
          ...
          {mode === CalculatorMode.PRINCIPAL_BASED_ON_ROI ? (
            ...
            <>
              <RoiDisplayContainer onClick={onEnterEditing}>
                ...
                <Text  color="#fff"fontSize="24px" bold>
                  $
                </Text>
                <RoiDollarAmount color="#fff" fontSize="24px" bold fadeOut={roiUSD > TRILLION}>
