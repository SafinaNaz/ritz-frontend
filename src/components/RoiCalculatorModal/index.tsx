...
const RoiCalculatorModal: React.FC<RoiCalculatorModalProps> = ({
  ...
  return (
    <StyledModal className="calculatormodel-bg"
    ...
    >
      <ScrollableContainer>
        <Flex flexDirection="column" mb="8px">
          <Text color="#fff" bold fontSize="12px" textTransform="uppercase">
          ...
          <Flex justifyContent="space-between" mt="8px">
            ...
            <span ref={targetRef}>
              <HelpIcon width="16px" height="16px" color="#fff" />
            </span>
            {tooltipVisible && tooltip}
          </Flex>
          <Text mt="24px" color="#fff" bold fontSize="12px" textTransform="uppercase">
            {t('Staked for')}
          </Text>
