...
const ListRow = memo(function ListRow({ listUrl }: { listUrl: string }) {
  ...
  return (
    <RowWrapper active={isActive} key={listUrl} id={listUrlRowHTMLId(listUrl)}>
      ...
      <Column style={{ flex: '1' }}>
        <Row>
          <Text color="#fff" bold>{list.name}</Text>
        </Row>
        <RowFixed mt="4px">
          <Text color="#fff" fontSize="12px" mr="6px" textTransform="lowercase">
            ...
            <RowBetween>
              <RowFixed>
                ...
                <AutoColumn gap="4px" style={{ marginLeft: '20px' }}>
                  <Text color="#fff" bold>{tempList.name}</Text>
                  <Text color="#fff" small textTransform="lowercase">
