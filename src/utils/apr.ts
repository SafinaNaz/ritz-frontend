...
export const getPoolApr = (
  ...
  console.log('!apr.isFinite()', !apr.isFinite())
  // for null value we using 0.000000001 * 1e9 value but for testnet
  return apr.isNaN() || !apr.isFinite() ? 0.000000001 * 1e9 : apr.toNumber()
}
